...
public class CittaMontagna extends ScreenAdapter {
    ...
    public void show() {
        try {
            ...
            int mapWidth = cittaGrotta.getProperties().get("width", Integer.class)
                    * cittaGrotta.getProperties().get("tilewidth", Integer.class);
            int mapHeight = cittaGrotta.getProperties().get("height", Integer.class)
                    * cittaGrotta.getProperties().get("tileheight", Integer.class);
            ...
            System.out.println("Errore show cittaMontagna, " + e);
        }
    ...
    private void settaPlayerPosition() {
        try {
            ...
            if (game.getIngressoCittaMontagna() != null) {
                ...
                for (MapObject object : objects) {
                    if (object instanceof RectangleMapObject) {
                        ...
                        // METTO IN INGRESSO CITTà MONTGNA IL NOME EFFETTIVO DEL RETTANGOLO IL CUI DEVO
            ...
            System.out.println("Errore settaPlayerPosition cittaMontagna, " + e);
        }
    ...
    private void cambiaProfondita(MapLayer lineeLayer) {
        try {
            ...
            System.out.println("Errore cambiaProfondita cittaMontagna, " + e);
        }
    ...
    private void renderLayer(String layerName) {
        ...
        try {
            ...
            System.out.println("Errore renderLayer cittaMontagna, " + e);
        }
    ...
    private String findGroupByLayerName(TiledMap map, String layerName) {
        try {
            ...
            System.out.println("Errore findGroupByLayerName cittaMontagna, " + e);
            return null;
        }
    ...
    private MapLayer findLayerInGroup(TiledMap map, String groupName, String layerName) {
        try {
            ...
            System.out.println("Errore findLayerInGroup cittaMontagna, " + e);
            return null;
        }
    ...
    private void controllaUscita() {
        try {
            ...
            System.out.println("Errore controlloUscita cittàMontagna, " + e);
        }
