...
public class infoPoke {
    ...
    public infoPoke(Stage stage, int numDelPoke, boolean box) {
        try {
            ...
            System.out.println("Errore constructor infoPoke, " + e);
        }
    }
    ...
    public void render() {
        try {
            ...
            System.out.println("Errore render infoPoke, " + e);
        }
    }
    ...
    private void clearInfoPoke() {
        try {
            ...
            System.out.println("Errore clearInfoPoke, " + e);
        }
    }
    ...
    public void leggiPoke(int numero, boolean box) {
        try {
            ...
            for (JsonValue mossaJson : mosse) {
                ...
                Mossa mossa = new Mossa(nomeMossa, tipoMossa, maxPP, attPP, null); // gli passo null invece che Battle
                                                                                   // se non ne ho bisogno
                listaMosse.add(mossa);
            }

        } catch (Exception e) {
            System.out.println("Errore leggoPoke infoPoke, " + e);
        }
    }
    ...
    private void aggiungiDati() {
        try {
            ...
            // attacco
            Label attacco = new Label(statsPlayer.get(indiciStatistiche.get("attack")),
            ...
            // difesa
            Label difesa = new Label(statsPlayer.get(indiciStatistiche.get("defense")),
                    new Label.LabelStyle(font2, null));
            ...
            // attacco speciale
            Label attaccoSp = new Label(statsPlayer.get(indiciStatistiche.get("special_attack")),
                    new Label.LabelStyle(font2, null));
            ...
            // difesa speciale
            Label difesaSp = new Label(statsPlayer.get(indiciStatistiche.get("special_defense")),
                    new Label.LabelStyle(font2, null));
            ...
            // velocità
            Label velocita = new Label(statsPlayer.get(indiciStatistiche.get("speed")),
                    new Label.LabelStyle(font2, null));
            ...
            for (int i = 0; i < listaMosse.size(); i++) {
                ...
                // pp
                Label ppMossa = new Label(listaMosse.get(i).getattPP() + "/" + listaMosse.get(i).getmaxPP(),
                        new Label.LabelStyle(font2, null));
            ...
            System.out.println("Errore aggiungiDati infoPoke, " + e);
        }
    ...
    private void placeHpBar(String currentHP, String maxHP) {
        try {
            ...
            System.out.println("Errore placeHpBar infoPoke, " + e);
        }
    }
    ...
    private Image placeExpBar() {
        try {
            ...
            System.out.println("Errore placeExpBar infoPoke, " + e);
            return null;
        }
    }
