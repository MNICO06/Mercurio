...
public class squadraCure {
    ...
    private void curaPokemon(int indexCurato){
        ...
        if(curaPs!=0){
            ...
            if(json2.get("poke"+indexCurato).get("statistiche").getString("hp").equals("0")){
            ...
            else if (json2.get("poke"+indexCurato).get("statistiche").getString("hp").equals(""+json2.get("poke"+indexCurato).get("statistiche").getInt("hpTot"))){
                ...
                int nuoviHP= Integer.parseInt(json2.get("poke"+indexCurato).get("statistiche").getString("hp"))+curaPs;
            ...
            if(json2.get("poke"+indexCurato).get("statistiche").getString("hp").equals("0")){
                ...
                int nuoviHP= Integer.parseInt(json2.get("poke"+indexCurato).get("statistiche").getString("hpTot"))/(100/rivitalizzazione);
                json2.get("poke"+indexCurato).get("statistiche").remove("hp");
                json2.get("poke"+indexCurato).get("statistiche").addChild("hp", new JsonValue(""+nuoviHP));
