...
public class Bot {
    ...
    public Bot(float width, float height, String texturePath, float xPunto, float yPunto, float inizio, float x,
            float y) {
        // inizio lo prendo da codice e serve per capire in base a dove parte (settato
        // come proprietà rettangolo)
        this.xPunto = xPunto;
        this.yPunto = yPunto;
        player_width = width;
        player_height = height;
    ...
    private void settaTutto(float width, float height, String texturePath, float xPunto, float yPunto) {
        try {
            ...
            System.out.println("Errore settaTutto bot, " + e);
        }
    ...
    public void muovilBot() {
        ...
        try {
            ...
            System.out.println("Errore muovilBot, " + e);
        }
    }
    ...
    public void faiNuotareBot(Ash ash) {
        ...
        try {
            if (muovi) {
                ...
                switch (direzione) {
                    case "-y":
                        ...
                        // characterPosition.y -= 40f * Gdx.graphics.getDeltaTime();
                        // boxFerma.set(characterPosition.x, characterPosition.y - direzioneRettangolo,
                        // 20, direzioneRettangolo);
                        break;
                    ...
                    case "y":
                        ...
                        // characterPosition.y += 40f * Gdx.graphics.getDeltaTime();
                        // boxFerma.set(characterPosition.x, characterPosition.y, 20,
                        // direzioneRettangolo);
                        break;
                ...
                if (muovi_Y != 0) {
                    ...
                    if (boxPlayer.overlaps(ash.getBoxPlayer())) {
                        ...
                        if (muovi_Y > 0) {
                            ...
                            boxFerma.set(characterPosition.x, characterPosition.y - direzioneRettangolo, 20,
                                    direzioneRettangolo);
                        }
                    }
                }
            ...
            boxPlayer.set(characterPosition.x + player_width / 4 - 2, characterPosition.y - 2, player_width / 2 + 2,
                    player_height / 6 + 6);

        } catch (Exception e) {
            System.out.println("Errore faiNuotareBot, " + e);
        }
    }
    ...
    public void avvicinaNuotatore() {
        try {
            ...
            System.out.println("Errore avvicinaNuotatore, " + e);
        }
